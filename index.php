      ...
      <div class="container-fluid">
        <div class="overflow-hidden">
          <div class="d-flex  align-items-baseline justify-content-between px-md-3 px-1 my-4">
            <h3 class="main-title text-capitalize mb-0">Módulos do <span class="fw-bold" style="color:rgba(135, 41, 222, 1);">Curso </span> <i style="background:rgba(135, 41, 222, 1);font-size:14px;margin-top:-5px" class="fa p-2 rounded-3   fa-book text-dark"></i></h3>
          </div>
