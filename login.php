                            ...
                            <h2 class="text-center SFProDisplayRegular">Conecte <br> <span class="SFProDisplayBold">sua conta</span></h2>
                                ...
                                <div class="mb-3 ">
                                    <label class="custom-checkbox mb-3 ">
                                        ...
                                        Ao clicar, você concorda com nossos <a href="#" data-bs-toggle="modal" data-bs-target="#staticBackdrop">&nbsp; termos e condições</a> 
                                    </label>
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>
        Este documento estabelece os Termos de Uso do Curso de Roleta (“Curso”) oferecido pela RM2 / Mágico do Século . Ao adquirir e participar deste Curso, você concorda em aderir aos termos e condições descritos abaixo, que têm como objetivo proporcionar um entendimento claro sobre a natureza do conteúdo oferecido e suas expectativas.
        </p>
        ...
        <p>7.1. Ao se inscrever no Curso, o participante declara que está ciente de que todo o conteúdo é destinado a fins de entretenimento e aprendizado, sem garantia de ganhos financeiros. 7.2. O participante concorda em não buscar indenizações ou compensações financeiras da RM2 / Mágico do Século  por quaisquer perdas decorrentes de suas atividades relacionadas à roleta.</p>
        <h3>8. Alterações nos Termos
        </h3>
        <p>8.1. A RM2 / Mágico do Século  se reserva o direito de modificar estes Termos de Uso a qualquer momento, notificando os participantes por meio de comunicado eletrônico ou na plataforma do Curso. 8.2. O participante é responsável por revisar os Termos de Uso periodicamente para estar ciente de quaisquer atualizações ou alterações.
        </p>
      </div>
