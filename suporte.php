        ...
        <section class="contact bg-light container-fluid">
            <div class="container bg-light">
                ...
                <div class="input-group input-group w-100">
                    <span class="input-group-text h-75  rounded-circle position-relative" style="left: 2rem;                 display: flex;                    height: 60px;                    margin-top: 0.5rem;">
                    ...
                    <span class=" px-5  w-75 bg-secondary rounded-pill text-center align-content-center " style="height: 60px;">
                        @magicosuporte
                    </span>
