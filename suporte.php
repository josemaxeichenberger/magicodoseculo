        ...
        <section class="contact bg-light container-fluid">
            <div class="container bg-light">
                ...
                <div class="input-group input-group w-100">
                    <span class="input-group-text  rounded-circle position-relative" style="left: 3rem;" >
                    ...
                    <span class=" px-5 py-5 w-75 bg-secondary rounded-pill text-center align-content-center ">
                    @magicosuporte
                    </span>
